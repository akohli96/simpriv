...
public class UserRepositoryImpl implements UserRepository {
	...
	private static final String getByPasswordQuery="SELECT * FROM USERS WHERE PASSWORD_HASH = ?";
	...
	public User create(UserDTO userDTO) throws SimPrivException {
		try {
			...
			jdbcTemplate.update(insertQuery, user.getName(),keyRetrieval.hashString(user.getPassword()));
			return user;
