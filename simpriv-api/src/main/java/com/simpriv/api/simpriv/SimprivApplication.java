package com.simpriv.api.simpriv;
...
public class SimprivApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		jdbcTemplate.execute("CREATE TABLE snippet(message_text varchar(255), password_hash varchar(255) unique, url_link varchar(255) unique)");
